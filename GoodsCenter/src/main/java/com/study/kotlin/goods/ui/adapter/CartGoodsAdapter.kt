...
import com.study.kotlin.goods.widgets.MyNumberButton
...
class CartGoodsAdapter(context: Context) : BaseRecyclerViewAdapter<CartGoods, CartGoodsAdapter.ViewHolder>(context) {
   ...
   override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        //商品数量变化监听
        holder.itemView.mGoodsCountBtn.setOnNumberChangeListener(object: MyNumberButton.OnNumberChangeListener{
